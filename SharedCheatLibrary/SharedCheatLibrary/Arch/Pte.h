...
struct Tables<Mode::longMode4Level> // EFER.LMA == 1, CR4.PAE is always 1, CR4.PSE is ignored, CR4.LA57 == 0
{
    ...
    __forceinline static constexpr PhysicalLayout<Pml4> pml4(const unsigned long long cr3Pfn) noexcept
    {
        return PhysicalLayout<Pml4>{ Pfn::toPage(cr3Pfn) };
    }

    __forceinline static constexpr PhysicalLayout<Pml4e> pml4e(const unsigned long long cr3Pfn, const LinearAddress& linear) noexcept
    {
